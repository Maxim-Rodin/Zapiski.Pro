...
import { trackTelegramClick } from "@/lib/metrika"
  ...
  return (
    <main id="top">
      <header className="site-header">
        ...
        <Button size="sm" asChild><a href={TELEGRAM_URL} target="_blank" rel="noopener noreferrer" onClick={() => trackTelegramClick("header")}>Попробовать <ArrowRight size={16} /></a></Button>
      ...
      <section className="hero-section" ref={heroRef}>
        ...
        <div className="hero-copy">
          ...
          <motion.div className="hero-actions" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: .24 }}>
            <Button size="lg" asChild><a href={TELEGRAM_URL} target="_blank" rel="noopener noreferrer" onClick={() => trackTelegramClick("hero")}>Попробовать бесплатно <ArrowRight size={18} /></a></Button>
          </motion.div>
      ...
      <section className="profile-showcase" id="profile">
        ...
        <div className="profile-showcase-copy">
          ...
          <Button size="lg" asChild><a href={TELEGRAM_URL} target="_blank" rel="noopener noreferrer" onClick={() => trackTelegramClick("public_profile")}>Создать свой профиль <ArrowRight size={18} /></a></Button>
        </div>
        <motion.div className="public-profile" {...reveal}>
          ...
          <a className="book-live" href={TELEGRAM_URL} target="_blank" rel="noopener noreferrer" onClick={() => trackTelegramClick("profile_demo")}>Записаться</a>
        </motion.div>
      </section>
      ...
      <a className="mobile-sticky" href={TELEGRAM_URL} target="_blank" rel="noopener noreferrer" onClick={() => trackTelegramClick("mobile_sticky")}>Попробовать бесплатно <ArrowRight size={17} /></a>
    </main>
  )
}
